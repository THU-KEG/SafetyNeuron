...
do
    ...
    INDEX_PEFT_NAME=(sharegpt_ia3_ff_${seed} sharegpt_ia3_ff_${seed}_${model}_dpo_ia3_ff)
    for MODEL in ${MODELS[@]}
    do
        PEFT_PATH=()
        GUIDED_PEFT_PATH=()
            ...
            do
                ...
                do
                    python -m eval.arena.run_eval \
                        ...
                        --guided_generation \
                        --index_path ${data_root}/hooked_llama/neuron_activation/${MODEL}_${INDEX_PEFT_NAME[-1]}_${index_path}.pt \
                        --value_path ${data_root}/hooked_llama/neuron_activation/${MODEL}_${INDEX_PEFT_NAME[-1]}_${index_path}.pt 
                    ...
                    #     --guided_generation \
                    #     --index_path ${data_root}/hooked_llama/neuron_activation/${MODEL}_${GUIDED_PEFT_NAME[-1]}_${index_path}.pt \
                    #     --value_path ${data_root}/hooked_llama/neuron_activation/${MODEL}_${GUIDED_PEFT_NAME[-1]}_${index_path}.pt 
                done
            done
        fi
    done
